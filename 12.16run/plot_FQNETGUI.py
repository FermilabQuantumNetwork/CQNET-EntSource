...
START_TIME = '2019-12-16 17:19:34'
END_TIME = '2019-12-16 20:30:00'#'NOW()'
...
try:
	...
	xmin=179#time_Vap_el_mins[0] #40
	xmax=190#time_Vap_el_mins[-1] #60
	...
	axs[5].set_xlim(xmin, xmax)
	#plt.legend()
	fig.suptitle("and2 mean = "+"{:.3f}".format(minVis)+", and2 std = "+"{:.3f}".format(minVisStd))
	plt.xlabel('Elapsed time (min)', fontsize =16)
	#plt.savefig(figname)
	...
	xmin=99#time_Vap_el_mins[0] #40
	xmax=110#time_Vap_el_mins[-1] #60
	GUI_indices = np.where((time_GUI_el_mins > xmin) & (time_GUI_el_mins < xmax))
	GUI_indices = GUI_indices[0]
	#print(GUI_indices)
	T_indices = np.where((time_T1_el_mins > xmin) &(time_T1_el_mins < xmax))
	...
	axs[5].set_xlim(xmin, xmax)
	#plt.legend()
	fig.suptitle("and2 mean = "+"{:.3f}".format(maxVis)+", and2 std = "+"{:.3f}".format(maxVisStd))
	plt.xlabel('Elapsed time (min)', fontsize =16)
	#plt.savefig(figname)
